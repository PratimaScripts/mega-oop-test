            ...
            {userRole === "landlord" && (
              <div className="col-xl-4">
                <div className="main_wrapper">
                  {selectedPlan.displayName === "Standard Yearly" && (
                  ...
                  <div className="menu">
                    ...
                    <div className="col-12 text-center my-4">
                      <SubscriptionButtons
                        onBuy={() => buySubscriptionModal(yearlyStandard)}
                        onCancel={() => cancelSubscriptionModal(yearlyStandard)}
            ...
            {userRole === "landlord" && (
              <div className="col-xl-4">
                <div className="main_wrapperThree">
                  {selectedPlan.displayName === "Premium Yearly" && (
                    <div className="current">
                      <Img
                        src={[
                          "https://res.cloudinary.com/dkxjsdsvg/image/upload/images/current-plan.webp",
                  ...
                  <div className="menuThree">
                    ...
                    <div className="col-12 text-center my-4">
                      <SubscriptionButtons
                        onBuy={() => buySubscriptionModal(yearlyPremium)}
                        onCancel={() => cancelSubscriptionModal(yearlyPremium)}
