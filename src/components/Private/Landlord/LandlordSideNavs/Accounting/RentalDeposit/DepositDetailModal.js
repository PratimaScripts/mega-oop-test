...
const DepositDetailModal = () => {
    ...
    const handleEdit = () => {
        dispatch({ type: 'CLOSE_DEPOSIT_MODAL' })
        dispatch({
            type: 'OPEN_CREATE_DEPOSIT_DRAWER_IN_EDIT_MODE',
            payload: depositDetail
        })
    }
            ...
            >
                ...
                >
                   <Descriptions.Item label="Reference Id">{depositDetail?.referenceId}</Descriptions.Item>
                    ...
                    <Descriptions.Item label="Renter"> Name: {depositDetail?.transaction?.contactId?.firstName} {depositDetail?.transaction?.contactId?.lastName} <br />
                                                            Email: {depositDetail?.transaction?.contactId?.email}
                    </Descriptions.Item>
