      ...
      return (
        <tr key={i}>
          ...
          <td className="bold__txt">
            zyPass {order.type === "Self" ? "Landlord" : order.type} Screening
          </td>
          <td>
    ...
    pendingOrders.map((order, i) => {
      ...
      return (
        <tr key={i}>
          ...
          <td className="bold__txt">{order.type}</td>
          <td>
            <span className="bold__txt">{order.isPayment ? "Yes" : "No"}</span>
          </td>
          <td>
            <span className="fas fa-calendar-check" />
            &nbsp;&nbsp;&nbsp;
