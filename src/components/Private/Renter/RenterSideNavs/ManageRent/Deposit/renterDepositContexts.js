...
const RenterDepositContext = createContext(initalState);

const { Provider } = RenterDepositContext;
let type = '';
...
const RenterDepositProvider = ({ children }) => {
...
export { RenterDepositProvider, RenterDepositContext }