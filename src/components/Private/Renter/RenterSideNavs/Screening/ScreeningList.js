  ...
  const checkOutOrder = () => {
    ...
    if (orders[activeScreeningOrder - 1].type !== "invite") {
      ...
      if (disableSelfOrder) {
        ...
        props.history.push(`/renter/screening/review`, {
          legit: true
        });
      }
          ...
          <div className="row">
                ...
                <div className="paid_line">
                  <center>
                    <p>
                      ...
                      &nbsp; <lab>£5.99</lab> (paid by tenant)
                    </p>
                  </center>
                </div>
                <div className="report">
                  <center>
                    <Link to="report/sample">View example report</Link>
                  </center>
                </div>
                <br></br>
                <div className="info">
            ...
            >
              <div className="option-card choice" name="1" value="1">
                ...
                <div className="report">
                  <center>
                    <Link to="report/sample/landlord">View example report</Link>
                  </center>
                </div>
                <br></br>
                <div className="info">
